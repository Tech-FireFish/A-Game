...
const SOUND_OPTIONS = [
  { id: "door-open", type: "mechanical" },
  { id: "door-locked", type: "mechanical" },
  { id: "rifle-shot", type: "weapon" },
  { id: "smg-shot", type: "weapon" },
  { id: "pistol-shot", type: "weapon" },
  { id: "silenced-shot", type: "weapon" },
  { id: "operator-down", type: "impact" },
  { id: "mission-success", type: "mission" },
  { id: "mission-failed", type: "mission" },
  { id: "window-break", type: "mechanical" },
  { id: "operator-walk", type: "loop" },
  { id: "enemy-walk", type: "loop" },
  { id: "button-guidance", type: "ui" },
  { id: "store-select", type: "ui" },
  { id: "store-purchase", type: "ui" },
  { id: "reload", type: "weapon" },
  { id: "empty-magazine-click", type: "weapon" },
  { id: "armor-hit", type: "impact" },
  { id: "body-hit", type: "impact" },
  { id: "melee-hit", type: "impact" },
  { id: "enemy-alert", type: "alert" },
  { id: "reload-complete", type: "weapon" },
  { id: "enemy-suspicious", type: "alert" },
  { id: "paper-pickup", type: "inventory" },
  { id: "gear-equip", type: "inventory" },
  { id: "inventory-open", type: "inventory" },
  { id: "inventory-close", type: "inventory" },
  { id: "digital-lock-correct", type: "mechanical" },
  { id: "digital-lock-keypad-press", type: "mechanical" },
  { id: "door-close", type: "mechanical" },
  { id: "window-open", type: "mechanical" },
  { id: "window-vault", type: "movement" },
  { id: "glass-step-damage", type: "impact" },
  { id: "stairs-use", type: "movement" },
  { id: "laptop-open", type: "mechanical" },
  { id: "hack-start", type: "mechanical" },
  { id: "camera-select", type: "mechanical" },
  { id: "objective-secured", type: "mission" },
  { id: "vip-harmed", type: "mission" },
  { id: "low-health-warning", type: "alert" },
